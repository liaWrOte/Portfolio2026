    ...
    switch (action.type) {
        ...
        case OPEN_WINDOW : {
            ...
            return {
                ...
                openedWindows: !(state.openedWindows.includes(windowId)) ? state.openedWindows.concat(windowId) : state.openedWindows,
            ...
            if (Array.isArray(action.value)) {
                ...
                if (action.value.length === 2) {
                    return {
                        ...
                        minimizedWindows: state.minimizedWindows.filter(window => !action.value.includes(window))
                    };
                }
            }
        }
